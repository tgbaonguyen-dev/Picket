      ...
      <div className="space-y-5 px-5 pb-8 pt-2">
        ...
        <PopIn className="relative overflow-hidden rounded-3xl bg-white/70 p-6 shadow-sm backdrop-blur-md">
          <div className="flex flex-col items-center text-center">
            <div className="flex h-32 w-32 items-center justify-center rounded-3xl bg-gradient-to-br from-gray-100 to-gray-200 text-7xl shadow-sm">
              💻
            </div>
            ...
            <div className="mt-5">
              <div className="inline-flex items-center gap-1.5 rounded-lg bg-foreground/5 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-foreground/60">
                <Tag className="h-3 w-3" /> Công nghệ
              </div>
              <p className="mt-2 text-2xl font-bold tracking-tight text-foreground">MacBook Pro M3</p>
              <p className="mt-1 text-3xl font-bold text-[#8F5F68]">{fmt(45000000)}</p>
            </div>
          </div>
        </PopIn>
        ...
        >
          <div className="rounded-3xl bg-white/70 p-5 shadow-sm backdrop-blur-md">
            ...
            <p className="mt-2 text-xl font-bold tabular-nums text-foreground/50">{fmt(38000000)}</p>
          ...
          <div className="rounded-3xl bg-emerald-50 p-5 shadow-sm">
            ...
            <p className="mt-2 text-xl font-bold tabular-nums text-emerald-600">6 Tháng</p>
            <p className="mt-0.5 text-[11px] font-medium text-emerald-600/70">Còn hiệu lực đến 15/01/2027</p>
          </div>
        </FadeInUp>
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm font-bold">15/01/2026</span>
          </div>
        ...
        >
          <button className="flex items-center justify-center gap-2 rounded-2xl bg-foreground py-4 text-[13px] font-bold text-background shadow-lg transition-transform active:scale-95">
